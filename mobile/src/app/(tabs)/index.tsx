      ...
      >
        ...
        <View className="mb-4 bg-slate-900 border border-slate-800 rounded-3xl p-5 shadow-sm">
          <View className="flex-row items-center space-x-3 mb-4">
            ...
            <View className="flex-1">
              <Text className="font-extrabold text-sm text-slate-200">Communication Skills</Text>
        ...
        {/* Aptitude Domain */}
        <View className="mb-8 bg-slate-900 border border-slate-800 rounded-3xl p-5 shadow-sm">
          <View className="flex-row items-center space-x-3 mb-4">
            <View className="p-2 bg-indigo-500/10 border border-indigo-500/20 rounded-xl mr-2.5">
              <CalendarDays size={18} color="#818cf8" />
            </View>
            <View className="flex-1">
              <Text className="font-extrabold text-sm text-slate-200">Aptitude & Reasoning</Text>
